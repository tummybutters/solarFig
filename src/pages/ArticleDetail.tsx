...
const ArticleDetail = () => {
  ...
  return (
    <main className="mobile-premium page-article-detail min-h-screen bg-[#f4eefb]">
      <Navbar />
      ...
      <section className="relative overflow-hidden bg-[#6f5b99] pb-16 pt-32 text-white sm:pb-20 sm:pt-36">
        ...
        <div className="relative mx-auto max-w-[1200px] px-6 sm:px-8">
          ...
          <h1 className="article-title-natural-wrap max-w-4xl text-4xl font-medium leading-[1.02] tracking-tight text-white drop-shadow-[0_6px_20px_rgba(0,0,0,0.45)] sm:text-6xl">
            {article.title}
          </h1>
