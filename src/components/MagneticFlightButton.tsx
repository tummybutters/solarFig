...
const MagneticFlightButton = () => {
    ...
    return (
        <button
            ...
            className="relative flex items-center gap-3 px-6 py-3 rounded-full border border-white/30 shadow-[0_4px_24px_rgba(0,0,0,0.06)] overflow-hidden transition-all duration-300"
            style={{
        ...
        >
            ...
            {/* Icon Container */}
            <span
                className="relative flex items-center justify-center w-8 h-8 rounded-full bg-gray-900"
                style={{
